System.register(['angular2/core', './../shared/services/subular-service', '../shared/directives/album-list/album-list', '../shared/services/player-service', '../shared/directives/subular-list-item/subular-list-item', '../shared/directives/subular-list-box/subular-list-box.service'], function(exports_1) {
    "use strict";
    ...
    var core_1, subular_service_1, album_list_1, player_service_1, subular_list_item_1, subular_list_box_service_1;
    var Playlists;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Playlists = (function () {
                function Playlists(dataService, playerService, subularService) {
                ...
                Playlists = __decorate([
                    ...
                    __metadata('design:paramtypes', [subular_service_1.SubularService, player_service_1.PlayerService, subular_list_box_service_1.SubularListBoxService])
                ], Playlists);
                return Playlists;
            }());
